...
// revisions - contains the committed revisions and used during commit phase for mongodb bulk updates
...
// setVerAndRev sets the given version and mongo revision into cache for given ns/key
...
// the write-sets to the mongo. We load revisions as a bonus along with the versions during
